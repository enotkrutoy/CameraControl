    ...
    <div className="min-h-screen bg-[#020202] text-white font-sans selection:bg-blue-500/40 overflow-x-hidden antialiased">
        ...
        <div className="max-w-[1700px] mx-auto px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                 ...
                 <span className="text-[9px] text-blue-500/60 font-mono font-bold">STABLE_3.2.0</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="text-right hidden sm:block">
              <p className="text-[9px] text-gray-600 uppercase font-black tracking-widest">Network</p>
      ...
      <main className="max-w-[1700px] mx-auto p-8 grid lg:grid-cols-[320px_1fr_420px] gap-10 relative z-10">
        ...
        <aside className="space-y-8">
          ...
          <div className="bg-gray-950/50 rounded-3xl border border-white/5 p-6 space-y-5">
            <div className="flex justify-between items-center">
              <h3 className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Creative Logic</h3>
              <div className="w-8 h-[1px] bg-white/10" />
            </div>
            <textarea 
              value={settings.creativeContext}
              onChange={(e) => setSettings(s => ({...s, creativeContext: e.target.value}))}
              placeholder="Inject cinematic directives... e.g. 'Golden hour lighting, anamorphic flare'"
            ...
            <div className="flex flex-wrap gap-2">
               {['Cyberpunk', 'Noir', 'Vivid', 'Moody'].map(tag => (
              ...
              <div className="relative aspect-video rounded-[2.5rem] overflow-hidden border border-white/5 bg-gray-950 shadow-2xl group">
                ...
                <div className="absolute bottom-8 left-8 flex items-center gap-4">
                  ...
                  <div className="font-mono">
                    ...
                    <p className="text-[8px] text-gray-500">BUFFER_ALLOCATED: {(sourceImage.size / 1024 / 1024).toFixed(2)} MB</p>
                  </div>
                </div>
              </div>
            ) : (
        ...
        <aside className="space-y-8">
            ...
            {result ? (
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-6 right-6 flex gap-2">
                   <button onClick={copyImageToClipboard} className="w-10 h-10 bg-black/60 backdrop-blur-md rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-white transition-all">
            ...
            {isGenerating && (
              <div className="absolute inset-0 bg-black/95 backdrop-blur-2xl z-50 flex flex-col items-center justify-center gap-8 px-10">
                ...
                <div className="text-center">
                  <p className="text-blue-400 font-black text-xs tracking-[0.5em] uppercase mb-3 animate-pulse">Neural_Processing</p>
          ...
          >
            <span className="relative z-10">{isGenerating ? 'COMPUTING...' : 'INITIALIZE RENDER'}</span>
          ...
          {error && <div className="p-5 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-500 text-[10px] font-mono leading-relaxed"><span className="font-bold mr-2">SYSTEM_ERR:</span>{error}</div>}
        </aside>
      </main>
